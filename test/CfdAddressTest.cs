...
namespace Cfd.xTests
{
  public class CfdAddressTest
  {
    ...
    public void AddressTest()
    {
      ...
      Assert.Equal("0014a7b5240519719dc53e980c8158565458466f8227", addr.GetLockingScript());
      ...
      Assert.Equal("0014f4b7463a98e4c248fecc737f180e204efc5a99b5", addr.GetLockingScript());
    }
    ...
    public void ConfidentialAddressTest()
    {
      ...
      Assert.Equal("76a914751e76e8199196d454941c45d1b3a323f1433bd688ac", caddr.GetAddress().GetLockingScript());
